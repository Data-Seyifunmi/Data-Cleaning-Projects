...
| File | Description |
|------|-------------|
| 'Data Cleaning.xlsx' | Original dataset before cleaning |
| 'Cleaned Dataset.xlsx' | Final cleaned dataset (with documentation sheet) |
...
- **Microsoft Excel** — Data inspection and structure review
